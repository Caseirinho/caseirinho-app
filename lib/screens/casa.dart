...
const brigadeiros = [
  ...
  },
  {
    ...
    "descricao": "O delicioso brigadeiro da vó com cobertura crocante de castanha de caju"
  },
  {
    "nome": "Brigadeiro de M&M's",
    "pic": "assets/brigadeiros/mms.jpg",
    "descricao": "O incrível brigadeiro da vó recheado com os confeitos mais queridos do mundo."
  },
];
...
class CasaScreen extends StatelessWidget {
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => buildItem(
                  context,
                  brigadeiros[index]["pic"],
                  brigadeiros[index]["nome"],
                  brigadeiros[index]["descricao"],
                ),
              ),
            ),
          ],
  ...
  Padding buildItem(context, pic, nome, descricao) {
    return Padding(
